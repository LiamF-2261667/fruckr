<head>
    ...
    <div class="chat-container">
        <a href="<?php echo current_url(); ?>/chat" class="logo-button"><img src="../Icons/chat.png" alt="Chat Icon"></a>
    </div>

    <!-- Id of the foodtruck -->
    <p id="foodtruckId" class="hidden"><?php echo $foodtruck->getId(); ?></p>
</head>
<body>
...
<script src="/js/foodtruckCustomerPage.js"></script>
